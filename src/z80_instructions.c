...
const Z80_Instruction ExtendedInstructions[96] = {
    ...
    { 0x44, "NEG",          OP_NONE,    0,      &NOP },
    { 0x45, "RETN",         OP_NONE,    0,      &NOP },
    { 0x46, "IM 0",         OP_NONE,    0,      &NOP },
    { 0x47, "LD I,A",       OP_NONE,    0,      &NOP },
    { 0x48, "IN C,(C)",     OP_NONE,    0,      &NOP },
    { 0x49, "OUT (C),C",    OP_NONE,    0,      &NOP },
    { 0x4A, "ADC HL,BC",    OP_NONE,    0,      &NOP },
...
Z80_Instruction Z80_FetchInstruction(Z80_CPU *z) {
    ...
    switch (op(z, 0)) {
        case PREF_EXTD:
            ...
            instruction = op(z, 1) >= 0xA0 ? ExtendedInstructions[op(z, 1) - 0x60] : ExtendedInstructions[op(z, 1) - 0x40];
            break;
        case PREF_BIT:
            break;
        case PREF_IX:
        ...
        default:
            ...
            instruction = MainInstructions[op(z, 0)];
            break;
    }
